...
stair_result  stairs(const BuildingData& d, double height_floor, int vertical_step, int horizontal_step)
{
    stair_result stair;
...
RC_column_result  RC_column(const BuildingData& d, double S, int G1 ,int G2 ,int n_floors ,
